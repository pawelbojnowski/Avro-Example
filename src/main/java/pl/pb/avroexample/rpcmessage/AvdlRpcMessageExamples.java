...
public class AvdlRpcMessageExamples {

    private static final pl.pb.avroexample.rpcmessages.avpr.RpcMessageData.Callback rpcMessageDataAvdl = new pl.pb.avroexample.rpcmessages.avpr.RpcMessageData.Callback() {
        ...
        @Override
        public void throwError() throws pl.pb.avroexample.rpcmessages.avpr.Error {
            throw new pl.pb.avroexample.rpcmessages.avpr.Error();
        }
        ...
        @Override
        public void logMessage(CharSequence message, org.apache.avro.ipc.Callback<Void> callback) {
            System.out.println(message);
        ...
        public void throwError(org.apache.avro.ipc.Callback<Void> callback) {
            callback.handleError(new pl.pb.avroexample.rpcmessages.avpr.Error());
        }
    };
    ...
    public static void main(String[] args) {
        try {
            /**
             * OUTPUT:
             * pl.pb.avroexample.rpcmessages.avpr.Error
             * add() handleResult: 3
             * Hello World
             * logMessage() handleResult: null
             * throwError() handleError: pl.pb.avroexample.rpcmessages.avpr.Error
             */
            ...
            } catch (pl.pb.avroexample.rpcmessages.avpr.Error e) {
